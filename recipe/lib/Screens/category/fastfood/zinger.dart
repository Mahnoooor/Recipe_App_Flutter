  ...
  Future<void> toggleFavoriteRecipe() async {
    ...
    if (currentUser != null) {
      ...
      if (recipeSnapshot.docs.isNotEmpty) {
        ...
        await recipeRef.add({
          'title': 'Zinger', // Provide the recipe details
...
"Dip the marinated chicken breast in the batter.",
"Roll it in dry flour.",
"Fry the chicken in a frying pan until crispy and golden in color.",
